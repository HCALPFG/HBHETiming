...
if choose == 1:
	rbxDir = "output/DelaySetting_09August2015/delay/"
	ttcrxPath = "output/DelaySetting_09August2015/ttcrx.xml"
	outDirPath = "check/2015-August-09-DelaySetting.txt"
else:
	rbxDir = "output/DelaySetting_12August2015/delay/"
	ttcrxPath = "output/DelaySetting_12August2015/TTCrxPhaseDelayRBX_0x187_tunedHTRs_tuned_v19m_12August2015.xml"
	outDirPath = "check/2015-August-12-DelaySetting.txt"
